 ...
 * 
 */
export const INSPTECTION_NORMAL= '正常'
export const INSPTECTION_EXCPTION_UNRESOLVE = '异常-未解决'
 ...
 * 
 */
export const USER_PERMISSION_VISITOR = 1;
export const USER_PERMISSION_EXECUTOR = 3;
export const USER_PERMISSION_MANAGER = 7;
export const USER_PERMISSION_ROOT = 15;
